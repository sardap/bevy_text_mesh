...
fn main() {
    App::new()
        ...
        .register_diagnostic(Diagnostic::new(TEXT_MESH_UPDATES).with_max_history_length(20))
...
pub const TEXT_MESH_UPDATES: DiagnosticPath = DiagnosticPath::const_new("text_mesh_updates");
